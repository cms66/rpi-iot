...
while [ $n != "x" ]; do
	case $n in
		1) sh /home/$usrname/.pisetup/rpi_setup_system.sh;;
		2) sh /home/$usrname/.pisetup/rpi_setup_hardware.sh;;
		3) sh /home/$usrname/.pisetup/rpi_setup_nfs.sh;;
		4) sh /home/$usrname/.pisetup/rpi_setup_ssh_keys.sh;;
		5) sh /home/$usrname/.pisetup/rpi_setup_openmpi.sh;;
		6) sh /home/$usrname/.pisetup/rpi_setup_opencv.sh;;
		7) sh /home/$usrname/.pisetup/rpi_setup_opencl.sh;;
  		8) sh /home/$usrname/.pisetup/rpi_setup_git_update.sh;;
