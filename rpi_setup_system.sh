...
apt-get -y install python python2.7-dev python3-dev gcc g++ gfortran libraspberrypi-dev libomp-dev git-core build-essential cmake pkg-config make screen htop stress zip nfs-common

# TODO - python-pip python3-pip fail2ban ufw
